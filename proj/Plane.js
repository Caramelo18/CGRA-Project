...
function Plane(scene, nrDivs, sMin, sMax, tMin, tMax) {
	...
	sMin = typeof sMin !== 'undefined' ? sMin : -0.5;
	sMax = typeof sMax !== 'undefined' ? sMax : 0.5;
	tMin = typeof tMin !== 'undefined' ? tMin : -0.5;
	tMax = typeof tMax !== 'undefined' ? tMax : 0.5;
...
Plane.prototype.initBuffers = function() {
	...
	*/
	...
	var yCoord = 0.5;
	var sPatchLength = (this.sMax - this.sMin) / this.nrDivs;
	var tPatchLength = (this.tMax - this.tMin) / this.nrDivs;
	
	
	var tCoord = this.tMin;
	
	for (var j = 0; j <= this.nrDivs; j++) 
	{
		var xCoord = -0.5;
		var sCoord = this.sMin;
